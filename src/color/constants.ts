...
export const COLORS = {
  ...
  GREEN: { r: 0, g: 255, b: 0 } as RGB,
  BLUE: { r: 0, g: 0, b: 255 } as RGB,
  YELLOW: { r: 255, g: 255, b: 0 } as RGB,
  CYAN: { r: 0, g: 255, b: 255 } as RGB,
  MAGENTA: { r: 255, g: 0, b: 255 } as RGB,
  TRANSPARENT: { r: 0, g: 0, b: 0, a: 0 } as RGBA,
} as const;

/**
 * CSS color names mapped to their RGB values
 */
...
export const COLOR_CONSTANTS = {
  ...
  /**
   * Maximum value for HSL hue
   */
  MAX_HUE: 360,

  /**
   * Maximum value for HSL saturation and lightness
   */
  MAX_SATURATION: 100,
  MAX_LIGHTNESS: 100,

  /**
   * Maximum value for alpha channel
   */
  MAX_ALPHA: 1,
