...
import { shallowEqualObjects } from '../..';
...
describe('shallowEqualObjects', () => {
  ...
  it('objects with null and undefined are not equal', () => {
    const obj1 = { a: 1, b: 'hello' };
    const obj2 = null;
  ...
  it('objects with the same null values are equal', () => {
    const obj1 = null;
    const obj2 = null;
  ...
  it('objects with undefined and null values are not equal', () => {
    const obj1 = { a: 1, b: 'hello' };
